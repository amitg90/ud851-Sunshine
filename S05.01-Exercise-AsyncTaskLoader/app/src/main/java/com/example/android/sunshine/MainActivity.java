...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final int LOCATION_SEARCH_LOADER_ID = 23;
    ...
    private void loadWeatherData() {
        ...
        if (loaderManager.getLoader(LOCATION_SEARCH_LOADER_ID) == null) {
            loaderManager.initLoader(LOCATION_SEARCH_LOADER_ID, bundle, this);
        } else {
            loaderManager.restartLoader(LOCATION_SEARCH_LOADER_ID, bundle, this);
        }
    }
