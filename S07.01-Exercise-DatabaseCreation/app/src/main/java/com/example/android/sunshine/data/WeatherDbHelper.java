...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        Log.e("!!AMIT!!", "Creating Table");
        final String SQL_CREATE_SUNSHINE_TABLE = "CREATE TABLE " + WeatherContract.WeatherEntry.TABLE_NAME + " (" +
                ...
                "); ";
        Log.e("AMIT!!", SQL_CREATE_SUNSHINE_TABLE);
        sqLiteDatabase.execSQL(SQL_CREATE_SUNSHINE_TABLE);
    }
