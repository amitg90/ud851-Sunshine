...
//  TODO (6) Declare constant IDs for the ViewType for today and for a future day
    private final int ViewType_Today = 1;
    private final int ViewType_Future = 2;
...
//      TODO (12) If the view type of the layout is today, use today layout
        ...
        } else if (viewType == ViewType_Future) {
            view = LayoutInflater
                    .from(mContext)
...
//      TODO (15) If the view type of the layout is today, display a large icon
        if (forecastAdapterViewHolder.getItemViewType() == ViewType_Today) {
            weatherImageId = SunshineWeatherUtils
                    .getLargeArtResourceIdForWeatherCondition(weatherId);
        } else if (forecastAdapterViewHolder.getItemViewType() == ViewType_Future) {
            weatherImageId = SunshineWeatherUtils
